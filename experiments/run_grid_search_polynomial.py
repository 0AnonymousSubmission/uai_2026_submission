...
from experiments.dataset_loader import load_polynomial_dataset 
...
"""
Grid search experiment runner for BTN with synthetic polynomial datasets.
Generates multivariate polynomial data and runs BTN experiments.
"""
...
def main():
    ...
    print(f"  Task: regression (BTN on polynomial data)")
    print(f"  Device: {DEVICE}")
    print(f"  Polynomial: degree={dataset_info['polynomial_degree']}, terms={dataset_info['polynomial_terms']}")
